...
class AddEventTest(unittest.TestCase):
    ...
    def test_add_event_data_type_error(self):
        ''' 日期格式错误 '''
        payload = {'eid':15,'name':'一加5手机发布会','limit':2000,'address':"深圳宝体",'start_time':'2017','time':self.client_time,'sign':self.sign_md5}
        r = requests.post(self.base_url,data=payload)
        result = r.json()
    ...
    def test_add_event_eid_exist(self):
        ''' id已经存在 '''
        payload = {'eid':1,'name':'一加4发布会','limit':2000,'address':"深圳宝体",'start_time':'2017-05-10 12:00:00','time':self.client_time,'sign':self.sign_md5}
        r = requests.post(self.base_url, data=payload)
        result = r.json()
    ...
    def test_add_event_name_exist(self):
        ''' 名称已经存在 '''
        payload = {'eid':10,'name':'一加手机发布会','limit':2000,'address':"深圳宝体",'start_time':'2017-05-10 12:00:00','time':self.client_time,'sign':self.sign_md5}
        payload1 = {'eid':15,'name':'一加手机发布会','limit':2000,'address':"深圳宝体",'start_time':'2017-05-10 12:00:00','time':self.client_time,'sign':self.sign_md5}
        r = requests.post(self.base_url,data=payload)
        r1 = requests.post(self.base_url,data=payload1)
        result = r1.json()
    ...
    def test_add_event_success(self):
        ''' 添加成功 '''
        payload = {'eid':15,'name':'一加8手机发布会','limit':2000,'address':"深圳宝体",'start_time':'2017-05-10 12:00:00','time':self.client_time,'sign':self.sign_md5}
        r = requests.post(self.base_url,data=payload)
        result = r.json()
